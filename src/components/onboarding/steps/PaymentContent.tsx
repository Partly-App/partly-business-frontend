...
const PaymentContent = ({ count: initialCount }: { count: number }) => {
    ...
    try {
      ...
      paddle.Checkout.open({
        ...
        settings: {
          ...
          variant: "one-page",
          theme: "dark",
          successUrl: `${window.location.origin}/onboarding/success?txnId=${data.txn}`,
      ...
      <div className="rounded-xl bg-grey-dark p-4">
        ...
        <div className="flex flex-col gap-2 pt-6">
          ...
          <div className="flex items-center gap-2">
            <Check size={24} className="text-purple-default" />
            <span>
              <span className="font-montserratAlt font-black">10-day</span> free
              trial
            </span>
          </div>
        </div>
